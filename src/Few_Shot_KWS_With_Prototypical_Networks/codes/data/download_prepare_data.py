...
class FewShotSpeechDataDownloader(object):
    ...
    def load_audio(self, audio_file, desired_samples):
        ...
        sound, sr = torchaudio.load(uri=audio_file, normalize=True,
                                         num_frames=desired_samples)
        return sound, sr
...
if __name__ == '__main__':
    ...
    dataset_path = "../../../../../NN_Impl_DataSets/speech_commands/"; #os.path.join(os.curdir, 'speech_commands')
    sample_rate = 16000
    clip_duration_ms = 1000
    speaker_limit = 1000
    core_split = (24,5,5) # (train, val, test)
